  ...
  return (
    <div style={S.app}>
      ...
      <main style={{...S.main,...(isMobile?{marginTop:56}:{})}}>
        ...
        {activeTab==="students"&&isAdmin&&<StudentsPage t={t} lang={lang} students={students} setStudents={setStudents} teachers={teachers} parents={parents} showNotif={showNotif}/>}
...
function StudentsPage({t,lang,students,setStudents,teachers,parents,showNotif}){
  const [showForm,setShowForm]=useState(false);
  const [editId,setEditId]=useState(null);
